...
function Footer() {
    return (
        <div className="h-[488px] w-full max-md:h-full">
            ...
            <div className="bg-[#fafafa] h-[142px] flex items-center px-[195px] justify-between max-md:h-full max-md:px-[46px] max-md:items-start">
            ...
            <div className="h-[272px] flex justify-between items-center w-full max-md:h-full">
                <div className="h-[170px] flex px-[195px] justify-between w-full max-md:py-10 max-md:px-0 max-md:h-full max-md:flex-col max-md:pl-[46px] max-md:gap-[30px]">
                    <FooterSection
