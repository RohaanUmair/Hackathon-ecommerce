...
function PriceCard({ heading, price, backgroundColor, color, color2 }: { heading: string, price: string, backgroundColor: string, color: string, color2: string }) {
    return (
        <div className='w-[327px] border border-[#23A6F0] flex flex-col items-center gap-[35px] py-[50px] md:rounded-[10px]' style={{backgroundColor}}>
            ...
            <div className='flex flex-col gap-[15px]'>
                ...
                <h6 className='flex items-center gap-[10px] text-sm font-bold' style={{color}}><div className='w-8 h-8 bg-[#2DC071] rounded-full text-white text-2xl flex justify-center items-center'><TiTick /></div> Unlimited product updates</h6>
                <h6 className='flex items-center gap-[10px] text-sm font-bold' style={{color}}><div className='w-8 h-8 bg-[#2DC071] rounded-full text-white text-2xl flex justify-center items-center md:hidden'><TiTick /></div> Unlimited product updates</h6>
                <h6 className='flex items-center gap-[10px] text-sm font-bold' style={{color}}><div className='w-8 h-8 bg-[#2DC071] rounded-full text-white text-2xl flex justify-center items-center md:hidden'><TiTick /></div> Unlimited product updates</h6>
            </div>
        </div>
    )
